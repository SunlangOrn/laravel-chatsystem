...
Route::prefix('google')->group(function () {
    Route::get('/{drive}/oauth/redirect', [OAuthController::class, 'googleOAuthRedirect']);
    Route::get('/{drive}/oauth/callback', [OAuthController::class, 'googleOAuthCallback']);
    Route::post('/oauth/exchange/token', [OAuthController::class, 'googleOAuthExchangeToken'])->middleware('auth:sanctum');
});
